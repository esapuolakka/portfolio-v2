...
function Homepage() {
  ...
  const [cards, setCards] = useState([
    ...
    { id: 3, title: 'Trivia', image: 'trivia-thumbnail.jpg', link: '/trivia', expanded: false, text: 'This is currently a simple app for fetching trivial questions from the Open Trivia DB. The app is still under development.'},
